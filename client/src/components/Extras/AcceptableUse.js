				...
				<div className="row">
					<div className="col-md-10 offset-md-1 font-16">
						...
						<p>
							...
							orientation or another similar characteristic. Any
							generalizations about these topics should be phrased
							as neutrally as possible.
						</p>
						<p>
							No Harassment and Bullying
							<br />
							Abusive behavior directed towards private
							individuals is not allowed. Repeated and unwanted
							contact constitutes a form of harassment. Content
							should not make threats against others or advocate
							violence, including self-harm.
						</p>
						<p>
							<b>Respect the Rights of Others</b>
						</p>
						<p>
						...
						<p>
							...
							<br />
							Do not post content that infringes any intellectual
							property or personal right of another party. Writing
							taken from another source should be properly
